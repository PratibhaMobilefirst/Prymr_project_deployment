  ...
  return (
    <div className="absolute inset-0 bg-black bg-opacity-75 flex items-center justify-center">
      ...
      <div className="absolute bottom-10 left-0 right-0 flex justify-center space-x-4 flex-wrap">
        <button
          className="bg-gray-800 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-lg"
        ...
        <button
          className="bg-blue-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-lg"
          onClick={handleApply}
        >
          Apply
        </button>
