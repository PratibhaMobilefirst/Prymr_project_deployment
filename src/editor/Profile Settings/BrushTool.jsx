...
const BrushTool = ({ image, onClose, onBrush }) => {
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center z-20 touch-none">
      <div className="bg-black bg-opacity-75 rounded-lg p-2 max-w-md mt-2 w-full sm:w-50 h-auto overflow-y-auto">
        <div className="flex justify-between items-center">
          <div className="text-white font-bold">Brush Tool</div>
